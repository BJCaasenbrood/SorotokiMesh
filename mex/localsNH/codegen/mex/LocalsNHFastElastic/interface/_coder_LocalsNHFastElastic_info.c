 ...
 *
 * _coder_LocalsNHFastElastic_info.c
 *
...
/* Include files */
#include "_coder_LocalsNHFastElastic_info.h"
#include "emlrt.h"
#include "tmwtypes.h"
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, (const char_T *)"Name",
                emlrtMxCreateString((const char_T *)"LocalsNHFastElastic"));
  ...
  emlrtSetField(
      ...
      emlrtMxCreateString(
          (const char_T *)"/home/brandon/Documents/MATLAB/SorotokiCode/src/fem/"
                          "mex/localsNH/LocalsNHFastElastic.m"));
  emlrtSetField(xEntryPoints, 0, (const char_T *)"TimeStamp",
                emlrtMxCreateDoubleScalar(738923.5904166667));
  xResult =
...
/* End of code generation (_coder_LocalsNHFastElastic_info.c) */
